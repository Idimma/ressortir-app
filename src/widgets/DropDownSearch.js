...
export default class SearchableDropDown extends Component {
  ...
  searchedItems = (searchedText = '') => {
    const onTextChange = this.props.onTextChange || this.props.textInputProps.onTextChange ||
      this.props.onChangeText || this.props.textInputProps.onChangeText;
  ...
  renderItems = (item) => {
    ...
    return (
      ...
      >
        <Text gray style={{ ...this.props.itemTextStyle }}>{item[indexName || 'name']}</Text>
      </TouchableOpacity>
    );
  };
