...
export const noAction = (e) => console.log(e);
...
export const loadWishList = () => {
  ...
  BookingService.fetchBookings()
    .then(({ data }) => {
      setAppState({ bookings: data.data });
    })
    .catch(noAction);
};
...
export const loadProfile = () => {
  setTimeout(() => {
    ...
    AuthService.getCommission()
      .then(({ data }) => {
        setAppState({ commissions: data.data });
      })
      .catch(noAction);

    AuthService.getCommissionInfo()
      .then(({ data }) => {
        setAppState({ info: data });
      })
      .catch(noAction);
    ...
    UserService.getNetwork()
      .then(({ data }) => {
        setAppState({ network: data.data });
      })
      .catch(noAction);
    loadWishList();
...
export const loadCart = () => CartService.all()
  .then(({ data }) => setAppState({ carts: data.data }))
  .catch(catchError);

export const loadOrder = (action = noAction) => OrderService.all()
  .then(({ data }) => {
