...
import { AuthService, CardService, PaystackService } from '../../../services';
import { catchError, loadProfile, Naira, showError, showSuccess } from '../../../utils';
// import random from 'lodash/random';
// import WebView from 'react-native-webview';
import RNPaystack from 'react-native-paystack';
import { AuthContext } from '../../../contexts/AuthContext';
import { View } from '../../../widgets';
import { setAppState, storeData } from '../../../utils/NavigationRef';
import { APP_IS_LOGGED_IN, PAYSTACK_PUBLIC_KEY } from '../../../utils/Constants';
    ...
    <SafeAreaView style={styles.flex}>
      <Formik
        ...
        validationSchema={Yup.object()
          .shape({
            cardNumber: Yup.string().min(16, 'Card number too short!').required('Card number is required'),
            expiryMonth: Yup.string().required('Expiration Month'),
            expiryYear: Yup.string().required('Expiration Year'),
        ...
        onSubmit={(values, {
          ...
          RNPaystack.chargeCard({
            ...
            .then(response => {
              ...
              AuthService.paystack(response.reference)
                .then(async ({data}) => {
                  console.log(data)
          ...
          <>
            ...
            <KeyboardAvoidingView>
              <View style={styles.header}>
                <Text font="p1">{Naira}5000 will be debited</Text>
              ...
              <View style={styles.form}>
                ...
                <TextField
                  ...
                  returnKeyType={'next'}
                />
                <Text color="gray50" mb={14}>Expiration (MM/YY)</Text>
                <View style={styles.row}>
                  <View flex row aligned spaced>
                    <View mr={5} style={styles.flex}>
                      <TextField
                        label="MM"
                        maxLength={2}
                ...
                <Text color="gray50">
                  I acknowledge that my card information is saved in my Agroinnovate account
                  and One Time Password might not be required for transactions on Agroinnovate.
                </Text>
              </View>
            </KeyboardAvoidingView>
            <View style={styles.buttonContainer}>
              <Button onPress={handleSubmit} label={`Debit ${Naira}5000`}   isLoading={isSubmitting}/>
            </View>
