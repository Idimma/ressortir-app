...
import { Naira, catchError, formatMoney, isIOS, loadProfile, showError } from "../../utils";
                            ...
                            {showProfile ?
                                ...
                                <View>
                                    ...
                                    <Card style={styles.card}>
                                        ...
                                        <BottomSheet hideButton sheetRef={showPayment}
                                        
                                        height={getScreenHeight() / 1.5}>
                                            <View style={styles.sheet}>
                                                <CardForm values={values} isLoggedIn={isLoggedIn} 
                                                onCancel={()=> showPayment.current.close()}
